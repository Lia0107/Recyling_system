...
class userDetail
{
    ...
    function recordUploadData($userID,$picname) // reload file
    {
      ...
      function recordUploadDataRecyclingForm($SubmitID,$picname) // reload file
      {
        ...
        public function reviseFormDetail($userID,$fname,$lname,$email,$phone,$saddress,$city,$zip,$country,$date,$time,$paper,$plastic,$metal,$electronic,$wood,$glass,$clothes,$bricks) 
        {
