...
if(isset($_POST['submit']) && isset($_FILES['file']))
{
  ...
  if(isset($_POST["submit"]))// click the submit button
  {
      ...
      if($paper>0 || $plastic>0 ||$metal>0 ||$electronic>0 ||$wood>0 ||$glass>0 ||$clothes>0 ||$bricks>0) //ensure the users got recycling the product 
      {
        ...
        {
          $userDetail->reviseFormDetail($SubmitID,$fname,$lname,$email,$phone,$saddress,$city,$zip,$country,$date,$time,$paper,$plastic,$metal,$electronic,$wood,$glass,$clothes,$bricks);
          if(isset($_POST['submit']) && isset($_FILES['file']))
          {
               ...
               {  
                ...
                ?>
                   ...
                   if($Errcountry=="")//if the error is empty this row does not appear
                    ...
                    <td class="people-des">
                    <h5><input id="amount" type="number"  min="0" max="100" name="paper" value="<?php echo $photo["paper"] ?>"/></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="plastic"  value="<?php echo $photo["plastic"] ?>"/></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="metal" value="<?php echo $photo["metal"] ?>"/></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="electronic"  value="<?php echo $photo["electronic"] ?>"/></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="wood"  value="<?php echo $photo["wood"] ?>"/></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="glass" value="<?php echo $photo["glass"] ?>" /></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="clothes"  value="<?php echo $photo["clothes"] ?>"/></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="bricks"  value="<?php echo $photo["bricks"] ?>"/></h5>
                    </td>
