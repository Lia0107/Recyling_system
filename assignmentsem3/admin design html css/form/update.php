...
if(isset($_POST["submit"]))// click the submit button
  { 
        ...
        if($paper>0 || $plastic>0 ||$metal>0 ||$electronic>0 ||$wood>0 ||$glass>0 ||$clothes>0 ||$bricks>0) //ensure the users got recycling the product 
        {
          ...
          { 
                $message=$admin->recordUploadData($fname,$lname,$email,$phone,$userID,$saddress,$city,$zip,$country,$date,$time,$paper,$plastic,$metal,$electronic,$wood,$glass,$clothes,$bricks,$dest_path);
                echo "<script>
