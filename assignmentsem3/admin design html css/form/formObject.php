...
class admin
{
    ...
    public function reviseFormDetail($userID,$fname,$lname,$email,$phone,$member,$saddress,$city,$zip,$country,$date,$time,$paper,$plastic,$metal,$electronic,$wood,$glass,$clothes,$bricks) 
    {
        $sql="UPDATE recyclingform set fname='$fname',lname='$lname', email='$email',phone='$phone',member='$member',saddress='$saddress',city='$city',
        zip='$zip',country='$country',date='$date',time='$time',paper='$paper',plastic='$plastic',metal='$metal',electronic='$electronic',wood='$wood',glass='$glass',clothes='$clothes',bricks='$bricks' Where SubmitID ='$userID'";
        if(mysqli_query($this->conn,$sql))
        {
            echo "<script>
            alert('Successful!!!!!');
    ...
    function recordUploadData($fname,$lname,$email,$phone,$member,$saddress,$city,$zip,$country,$date,$time,$paper,$plastic,$metal,$electronic,$wood,$glass,$clothes,$bricks,$picname) // reload file
    {
        ...
        wood, glass, clothes, bricks, picname) VALUES
