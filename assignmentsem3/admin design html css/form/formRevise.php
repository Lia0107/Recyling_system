<?php 
        ...
        if(isset($_POST["enter"])) // this button is revise the detail of users
        {
            ...
            if($vali->register==8)
            {
                $admin->reviseFormDetail($SubmitID,$fname,$lname,$email,$phone,$member,$saddress,$city,$zip,$country,$date,$time,$paper,$plastic,$metal,$electronic,$wood,$glass,$clothes,$bricks);
            }
        }
        if(isset($_POST["back"]))
        {
            ...
            ?>
                ...
                <tr>
                   ...
                   if($Errcountry=="")//if the error is empty this row does not appear
                    ...
                    <td class="people-des">                      
                        <h5><input type="date" id="date" name="date" min="<?= date("Y-m-d")?>" value="<?php echo $row['date']?>"></h5>
                    </td>
                    <td class="people-des">                       
                        <h5><input type="time" id="time" name="time" min="<?= date('09:00')?>" max="<?= date('17:00')?>" value="<?php echo $row['time']?>"></h5>
                    </td>

                    <td class="people-des">
                    <h5><input id="amount" type="number"  min="0" max="100" name="paper"  value="<?php echo $row["paper"] ?>"/></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="plastic" value="<?php echo $row["plastic"] ?>"/></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="metal" value="<?php echo $row["metal"] ?>"/></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="electronic" value="<?php echo $row["electronic"] ?>" /></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="wood" value="<?php echo $row["wood"] ?>"/></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="glass" value="<?php echo $row["glass"] ?>"/></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="clothes" value="<?php echo $row["clothes"] ?>"/></h5>
                    </td>
                    <td class="people-des">
                    <h5><input id="amount" type="number" min="0" max="100"  name="bricks"  value="<?php echo $row["bricks"] ?>"/></h5>
                    </td>
