...
{ 
    ...
    if($terms=="yes")  //user must tick the terms and condition checkbox
    {
      if($paper>0 || $plastic>0 ||$metal>0 ||$electronic>0 ||$wood>0 ||$glass>0 ||$clothes>0 ||$bricks>0) //ensure the users got recycling the product 
      {
        ...
        { 
              $message=$upload->recordUploadData($fname,$lname,$email,$phone,$userID,$saddress,$city,$zip,$country,$date,$time,$paper,$plastic,$metal,$electronic,$wood,$glass,$clothes,$bricks,$dest_path);
...
<html>
  ...
  <body>
    ...
    <legend>Item List</legend> 
        ...
        <div class="colums">
          <div class="item">
            ...
            <input id="amount" type="number"  min="0" max="100" name="paper" />
          </div>
          <div class="item">
            <label for="amount">Plastic Recycling</label>
            <input id="amount" type="number"  min="0" max="100" name="plastic" />
          </div>
          <div class="item">
            <label for="amount">Metal Recycling</label>
            <input id="amount" type="number" min="0" max="100"  name="metal" />
          </div>
          <div class="item">
            <label for="amount">Electronic Devices Recycling</label>
             <input id="amount" type="number" min="0" max="100"  name="electronic" />
          </div>
          <div class="item">
            <label for="amount">Wood Recycling</label>
            <input id="amount" type="number" min="0" max="100"  name="wood" />
          </div>
          <div class="item">
            <label for="amount">Glass Recycling</label>
            <input id="amount" type="number" min="0" max="100"  name="glass" />
          </div>
          <div class="item">
            <label for="amount">Clothes and Textile Recycling</label>
            <input id="amount" type="number" min="0" max="100"  name="clothes" />
          </div>
          <div class="item">
            <label for="amount">Bricks and Inert Waste Recycling</label>
            <input id="amount" type="number"  min="0" max="100" name="bricks" />
          </div>
        </div> 
    </fieldset><br>
    ...
    <div class="checkbox">
      ...
      <label for="terms">I have read and agree the <a href="T&C.html" target="_blank">Terms and Conditions</a>.</label><br>
