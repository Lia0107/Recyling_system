...
<head>
	...
	$errorP=" ";
		...
		{
			$LpasswordErr=$Vali->LErrPassword();
			$LemailErr=$Vali->LErrEmail();
		...
		{	
			...
			if($Vali->register==3) //if the number ==3 
			{
		...
		<input type="checkbox" id="chk" aria-hidden="true">
			...
			<div class="login"><!--login page-->
				<form action="login.php" method="post">
					...
					<div class="Error"><?php echo $errorP; ?></div>
					<span class="Error"><?php echo $LemailErr; ?></span>
					<input type="email" name="Lemail" placeholder="Email"  list="email-list">
					<span class="Error"><?php echo $LpasswordErr;?></span>
